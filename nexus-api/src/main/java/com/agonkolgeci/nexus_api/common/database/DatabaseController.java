package com.agonkolgeci.nexus_api.common.database;
...
import com.agonkolgeci.nexus_api.utils.storage.DatabaseUtils;
...
@Getter
public class DatabaseController extends PluginModule<NexusPlugin> {

    @NotNull private final HikariConfig hikariConfig;
    @NotNull private final HikariDataSource hikariDataSource;

    public DatabaseController(@NotNull NexusPlugin instance, @NotNull ConfigSection configuration) {
        super(instance);
    ...
    public void loadSchema(@NotNull InputStream schema) throws IOException {
