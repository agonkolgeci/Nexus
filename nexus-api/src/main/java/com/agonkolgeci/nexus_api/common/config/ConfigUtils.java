...
import com.agonkolgeci.nexus_api.common.database.DatabaseCredentials;
...
public class ConfigUtils {
    ...
    @NotNull
    public static World retrieveWorld(@NotNull NexusPlugin instance, @NotNull ConfigSection configuration) {
