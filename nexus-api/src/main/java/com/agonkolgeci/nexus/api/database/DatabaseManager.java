...
@Getter
public class DatabaseManager extends PluginManager<AbstractPlugin> implements PluginAdapter {

    @NotNull private final HikariConfig hikariConfig;
    @NotNull private final HikariDataSource hikariDataSource;

    @NotNull private final InputStream schema;

    public DatabaseManager(@NotNull AbstractPlugin instance, @NotNull ConfigSection configuration, @NotNull InputStream schema) {
        super(instance);
