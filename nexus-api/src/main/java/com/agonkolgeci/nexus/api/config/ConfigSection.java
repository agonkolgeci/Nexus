...
import com.agonkolgeci.nexus.api.config.callback.any.ConfigurationObjectCallback;
import com.agonkolgeci.nexus.api.config.callback.type.ConfigurationTypeCallback;
import com.agonkolgeci.nexus.api.config.callback.type.ConfigurationTypeObjectCallback;
...
public class ConfigSection {
    ...
    public ConfigSection(@NotNull ConfigManager configManager, @NotNull ConfigurationSection configuration) {
        this.configManager = configManager;

        this.configuration = configuration;
        this.parent = (configuration.getParent() != null ? new ConfigSection(configManager, configuration.getParent()) : null);
    }
    ...
    public String getPath() {
        return Objects.requireNonNull(configuration.getCurrentPath(), "Current path is null");
    }

    @NotNull
    public ConfigSection of(@NotNull String... path) {
        return new ConfigSection(configManager, configManager.requireConfigurationSection(configuration, path));
    }
